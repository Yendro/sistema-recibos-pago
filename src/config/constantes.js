...
const NOMBRES_ARCHIVOS = Object.freeze({
  ...
  INDICE_RECIBOS: "indice-recibos.json",
...
const CLAVES_PROPIEDADES = Object.freeze({
  ...
  DIRECTORIO_CONTENEDOR: "ID_DIRECTORIO_CONTENEDOR",
  ...
  ARCHIVO_INDICE_RECIBOS: "ID_ARCHIVO_INDICE_RECIBOS",
  HOJA_REPORTE: "ID_HOJA_REPORTE",
});

const CLAVES_MEMORIA_TEMPORAL = Object.freeze({
  CONFIGURACION_WEB: "CONFIGURACION_WEB_V4",
  RESUMEN_RECIBOS: "RESUMEN_RECIBOS_V4",
});
